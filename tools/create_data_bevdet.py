...
def add_ann_adj_info(extra_tag):
    ...
    # dataroot = '/opt/data/private/codeN1/BEVDet/data/nuscenes/' # mini
    dataroot = '/opt/data/private/codeN1/mmdetection3d/data/nuscenes/'
    nuscenes = NuScenes(nuscenes_version, dataroot)
    for set in ['train', 'val']:
        dataset = pickle.load(
            open('/opt/data/private/codeN1/mmdetection3d/data/nuscenes/%s_infos_%s.pkl' % (extra_tag, set), 'rb'))
        for id in range(len(dataset['infos'])):
            ...
            dataset['infos'][id]['occ_path'] = \
                '/opt/data/private/codeN1/BEVDet/data/nuscenes/gts/%s/%s'%(scene['name'], info['token'])
        with open('/opt/data/private/codeN1/mmdetection3d/data/nuscenes/%s_infos_%s.pkl' % (extra_tag, set),
                  'wb') as fid:
...
if __name__ == '__main__':
    ...
    root_path = '/opt/data/private/codeN1/mmdetection3d/data/nuscenes/'
