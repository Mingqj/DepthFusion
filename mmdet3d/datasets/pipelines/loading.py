...
class LoadPointsFromMultiSweeps(object):
    ...
    def _load_points(self, pts_filename):
        ...
        try:
            # pts_filename = '/gongshenjian/jimingqian/BEVDet/data/nuscenes/' + pts_filename[53:]
            if os.path.exists(pts_filename) != True:
                # pts_filename = '/opt/data/common/nuScenes_org/data_v1.0-trainval/' +  pts_filename[46:]
                pts_filename = '/opt/data/private/codeN1/mmdetection3d/data/nuscenes-test/' +  pts_filename[46:]
...
class LoadPointsFromFile(object):
    ...
    def _load_points(self, pts_filename):
        ...
        try:
            if os.path.exists(pts_filename) != True:
                pts_filename = "/opt/data/private/codeN1/mmdetection3d/data/nuscenes/full-bevdetv3-nuscenes_gt_database/" + pts_filename[83:]
                # pts_filename = '/opt/data/private/codeN1/mmdetection3d/data/nuscenes-test/' + pts_filename[53:]
            pts_bytes = self.file_client.get(pts_filename)
            points = np.frombuffer(pts_bytes, dtype=np.float32)
        except ConnectionError:
            mmcv.check_file_exist(pts_filename)
    ...
    def get_inputs(self, results, flip=None, scale=None):
        ...
        for cam_name in cam_names:
            ...
            if os.path.exists(filename) != True:
                # pts_filename = '/opt/data/common/nuScenes_org/data_v1.0-trainval/' +  pts_filename[46:]
                filename = '/opt/data/private/codeN1/mmdetection3d/data/nuscenes-test/' +  filename[53:]
