...
try:
    ...
    from mmdet3d.datasets.pipelines.utils.wet_ground.utils import plot_2d_hist
    from mmdet3d.datasets.pipelines.utils.wet_ground.planes import calculate_plane
    from mmdet3d.datasets.pipelines.utils.wet_ground.phy_equations import total_transmittance_from_ground
