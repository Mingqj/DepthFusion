...
import mmdet3d.datasets.pipelines.utils.snowfall.geometry as g

from mmdet3d.datasets.pipelines.utils.wet_ground.planes import calculate_plane
from mmdet3d.datasets.pipelines.utils.wet_ground.augmentation import estimate_laser_parameters
...
def get_occlusions(beam_angles: np.ndarray, ranges_orig: np.ndarray, root_path: str, particle_file: str,
    ...
    if root_path:
        ...
        path = Path(__file__).parent.parent.parent.absolute() / 'npy' / 'npy' / particle_file
