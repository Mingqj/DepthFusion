...
class DeformableAttention1D(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.to_de = nn.Conv1d(dim, inner_dim, 1, groups = offset_groups if group_queries else 1, bias = False)
    ...
    def forward(self, x_q, x_kv, De, return_vgrid = False):
        ...
        heads, b, n, downsample_factor, device = self.heads, x_q.shape[0], x_q.shape[-1], self.downsample_factor, x_q.device
